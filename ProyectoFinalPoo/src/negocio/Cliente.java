...
public class Cliente 
{
    ...
    public Cliente(String idCliente, String nombre, String foto, char genero, boolean[] productos) {
    ...
    public String toString() 
    {
        ...
        return this.idCliente+","+ this.nombre+","+ this.foto+","+this.genero+","+productos;
    }
